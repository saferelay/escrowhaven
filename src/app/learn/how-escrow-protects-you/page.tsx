      ...
      <section className="py-16 lg:py-24 border-t border-[#E0E2E7]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <button
            ...
            className="px-[32px] py-[12px] bg-[#2962FF] text-white rounded-[8px] font-medium text-[16px] hover:bg-[#1E53E5] transition-all duration-200 transform hover:translate-y-[-1px] hover:shadow-lg active:translate-y-0"
          >
