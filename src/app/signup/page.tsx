          ...
          {!isSuccess ? (
            <form className="space-y-6" onSubmit={handleSignup}>
              ...
              <div className="text-xs text-gray-500 text-center">
                ...
                <a href="/terms" className="text-[#2563EB] hover:text-[#1d4ed8]">
                  Terms of Service
                </a>{' '}
                and{' '}
                <a href="/privacy" className="text-[#2563EB] hover:text-[#1d4ed8]">
                  Privacy Policy
                </a>
              </div>
            </form>
            ...
            <div className="text-center">
              ...
              <button
                onClick={() => router.push('/')}
                className="mt-6 text-sm text-[#2563EB] hover:text-[#1d4ed8]"
              >
                Go back to home
              </button>
            </div>
